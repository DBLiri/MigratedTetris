...
struct Z_CompiledInDeferFile_FID_Users_Dylan_Documents_Unreal_Projects_MigratedTetris_SUPER_DUPER_TETRIS_Source_SUPER_DUPER_TETRIS_MySaveGame_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMySaveGame, UMySaveGame::StaticClass, TEXT("UMySaveGame"), &Z_Registration_Info_UClass_UMySaveGame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMySaveGame), 3585281983U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Dylan_Documents_Unreal_Projects_MigratedTetris_SUPER_DUPER_TETRIS_Source_SUPER_DUPER_TETRIS_MySaveGame_h_2706369703(TEXT("/Script/SUPER_DUPER_TETRIS"),
